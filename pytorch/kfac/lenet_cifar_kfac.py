...
def ACTIVATIONBACK( module, grad_input, grad_output ):  
   print( 'LInear ACTIVATION BACK.. ')
   print( 'Grad_input: ', grad_input )
   print( 'Grad_Output: ', grad_output )

class LeNetCIFARKFAC(nn.Module):

    def __init__(self, num_classes=10, activation='relu', batchSize=256, kfac=None, bias=False, r = 0 ):
        ...
        #self.a3.register_backward_hook( ACTIVATIONBACK)
        self.a1 = Swish ()
        self.a2 = Swish ()
        self.a3 = Swish ()
        self.a4 = Swish ()
    ...
    def forward(self, x): 
        if self.activation == 'softplus': 
            ...
            print( 'Weights: ', self.conv1.weight.data[ 0, 0, :, : ] )
            print( 'data: ', x[ 0, 0, :, : ] )
    ...
    def computeGradientIter( self, X, Y ): 
        ...
        return g
        #return (loss.cpu().item () / X.shape[0] + lossreg ), (g / X.shape[0]).data.add_(gradreg)
