...
void initRMSPropParams( RMSPROP_PARAMS *params, int n )
{
...
void testRMSProp (NN_MODEL *model, DEVICE_DATASET *data, 
		SCRATCH_AREA *scratch ) {

	RMSPROP_PARAMS mParams; 

	//begin here
	fprintf( stderr, "Initiating the Trust Region Test now..... \n\n\n");
	initRMSPropParams( &mParams, data->trainSizeX );
	...
	*/
	...
	rmsprop ( model, data, scratch, &mParams ); 

	fprintf( stderr, ".... Done testing of RMSProp \n\n\n" ); 
}
